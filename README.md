...
| ランク変化 | 相手ランク低下付与 | ✅ | あまえる / いやなおと / こわいかお / しっぽをふる / にらみつける等。`opp_alive` の時のみ付与 |
...
| 攻撃技 | 反動技 (HP 減算) | ✅ | ブレイブバード 1/3 / すてみタックル 1/4 / はめつのひかり 1/2 等 12 種 |
| 攻撃技 | 自滅技 (self-KO) | ✅ | じばく / だいばくはつ |
| 攻撃技 | 複数ターン技 / 2 ターン溜め | ❌ | ソラビ / ダイビング / フリーズドライ。はかいこうせん系は `recharge` フィールドで model 化済みだが挙動は未実装 |
